...
public enum CourseSiteTabPropertyType {
    ...
    CS_TAB_BANNER_EXPORT_DIR_LABEL,
    CS_TAB_PAGES_LABEL,
    ...
    CS_TAB_STYLE_BOX,
    CS_TAB_FOOLPROOF_DESIGN,
    CS_TAB_ICON_IMAGE_VIEW,
    CS_TAB_NAVBAR_IMAGE_VIEW,
    CS_TAB_LEFT_FOOTER_IMAGE_VIEW,
    CS_TAB_RIGHT_FOOTER_IMAGE_VIEW,
    CS_TAB_PAGES_ERROR_TITLE,
    CS_TAB_PAGES_ERROR_MESSAGE,
