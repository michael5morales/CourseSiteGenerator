 ...
 */
package coursesite.workspace.style;
...
public class CSStyle {
    ...
    public static final String CLASS_CS_PANE          = "cs_pane";
    public static final String CLASS_CS_BOX           = "cs_box";            
    public static final String CLASS_CS_HEADER_LABEL  = "cs_header_label";
    public static final String CLASS_CS_PROMPT        = "cs_prompt";
    public static final String CLASS_CS_TEXT_FIELD    = "cs_text_field";
    public static final String CLASS_CS_BUTTON        = "cs_button";
